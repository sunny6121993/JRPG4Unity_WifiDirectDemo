...
public class WifiP2pPlayerController : MonoBehaviour, IAttackHandler, IDefenceHandler
{
	...
	//
	private WifiP2pHandler wifiP2pObject;
	public WifiP2pHandler WifiP2pObject{
		set { wifiP2pObject = value; }
	}
	public WifiP2pController wifiP2pController;
    ...
    public void OnDefence()
    {
        ...
        playerGuis[0].IsCommandShown = false;
		wifiP2pController.noticePlayerDefense((int)wifiP2pController.currentTurn);
		turnHandler.OnTurnEnd((int)CombatSystemController.Turn.Player);
    }
